package com.renren.ruolan.travelaround.widget.carousel;
...
public class FlyBannerSecond extends RelativeLayout {
    ...
    //指示点是否可见
    private boolean mPointsIsVisible = false;
    ...
    public FlyBannerSecond(Context context) {
        this(context, null);
    }

    public FlyBannerSecond(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FlyBannerSecond(Context context, AttributeSet attrs, int defStyleAttr) {

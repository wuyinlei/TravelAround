...
public class PullUpToLoadMore extends ViewGroup {
    ...
    DetailScrollView topScrollView, bottomScrollView;
    ...
    private void init() {
        ...
        post(new Runnable() {
            @Override
            public void run() {
                topScrollView = (DetailScrollView) getChildAt(0);
                bottomScrollView = (DetailScrollView) getChildAt(1);
                topScrollView.setScrollListener(new DetailScrollView.ScrollListener() {
                    @Override
                ...
                bottomScrollView.setScrollListener(new DetailScrollView.ScrollListener() {
                    @Override
                    public void onScrollToBottom() {

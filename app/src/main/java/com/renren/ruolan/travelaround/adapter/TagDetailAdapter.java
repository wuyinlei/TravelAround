...
public class TagDetailAdapter extends SimpleAdapter<TagData.ResultEntity.ProductListEntity> {
    ...
    @Override
    protected void convert(BaseViewHolder viewHoder, TagData.ResultEntity.ProductListEntity item) {
        Glide.with(context)

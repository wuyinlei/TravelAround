...
public class FragmentArticleAdapter extends SimpleAdapter<DiscoveryArticleData.ResultBean.ArticleListBean> {
    ...
    @Override
    protected void convert(BaseViewHolder viewHoder, DiscoveryArticleData.ResultBean.ArticleListBean item) {
